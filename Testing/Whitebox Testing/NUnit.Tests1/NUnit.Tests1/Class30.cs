...
namespace SeleniumTests
{
    ...
    public class Class30
    {
        ...
        [Test]
        public void TestSuperadminediteventpost()
        {
            ...
            driver.FindElement(By.XPath("(//a[contains(text(),'EVENT POST')])[2]")).Click();
            driver.FindElement(By.XPath("(//a[contains(text(),'Select')])[2]")).Click();
            driver.FindElement(By.Id("ctl00_ContentPlaceHolder1_TxtEditEvent")).Clear();
            driver.FindElement(By.Id("ctl00_ContentPlaceHolder1_TxtEditEvent")).SendKeys("What about event?");
            driver.FindElement(By.Id("ctl00_ContentPlaceHolder1_BtnEditEvent")).Click();
