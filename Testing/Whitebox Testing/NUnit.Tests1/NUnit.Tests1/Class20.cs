...
namespace SeleniumTests
{
    ...
    public class Class20
    {
        ...
        [Test]
        public void TestCulturalapprovepost()
        {
            driver.Navigate().GoToUrl(baseURL + "/WebForm2.aspx");
            driver.FindElement(By.Id("txtUserName")).Clear();
            driver.FindElement(By.Id("txtUserName")).SendKeys("admincultural");
            driver.FindElement(By.Id("txtpassword")).Clear();
            driver.FindElement(By.Id("txtpassword")).SendKeys("admincl");
            driver.FindElement(By.Id("btnSubmit")).Click();
            driver.FindElement(By.XPath("(//a[contains(text(),'DELETE POST')])[2]")).Click();
