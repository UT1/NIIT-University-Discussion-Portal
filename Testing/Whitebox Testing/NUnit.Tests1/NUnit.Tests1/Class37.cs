...
namespace SeleniumTests
{
    ...
    public class Class37
    {
        ...
        [Test]
        public void TestSuperadminedituserprofilepost()
        {
            ...
            driver.FindElement(By.Id("ctl00_ContentPlaceHolder1_Txtemail")).SendKeys("bhargavashronit@gmail.com");
            driver.FindElement(By.Id("ctl00_ContentPlaceHolder1_Edit")).Click();
