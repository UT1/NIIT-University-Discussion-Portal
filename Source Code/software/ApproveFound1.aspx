<%@ Page Language="C#" MasterPageFile="~/Site6.Master" AutoEventWireup="true" CodeBehind="ApproveFound1.aspx.cs" Inherits="software.ApproveFound1" Title="Untitled Page" %>
...
<h3>Subject:</h3>
    ...
    <ItemTemplate>
    <img alt ="" src ="../images/<%#Eval("image") %>"  style =" max-height:250px; max-width:250px;"/>
    </ItemTemplate>
    </asp:Repeater>
    <h3>Comment:</h3>
