<%@ Page Language="C#" MasterPageFile="~/Site6.Master" AutoEventWireup="true" CodeBehind="Editfoundpost1.aspx.cs" Inherits="software.Editfoundpost1" Title="Untitled Page" %>
...
<asp:GridView ID="GridView1" runat="server" Width="750px" 
        ...
        AllowSorting="True" AutoGenerateColumns="False" >
         <Columns>
                        ...
                        <asp:BoundField DataField="Image" HeaderText="Image Name" ItemStyle-HorizontalAlign="Center" /> 
...
<h3>Subject:</h3>
    ...
    <h3>Description:</h3>
    <asp:TextBox ID="TxtEditFound" runat="server" style ="height:200px;"  Columns="40" TextMode = "MultiLine"></asp:TextBox><br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="Please enter Description" 
    ControlToValidate="TxtEditFound" runat="server" />
   
   <h3>Select images:</h3>
    <asp:FileUpload ID="FileUpload1" runat="server" />

    <asp:Button ID="BtnEditFound" runat="server"
        Text="EDIT"  onclick="BtnEditFound_Click"/><br/>
    </div>
    </center>
</asp:Panel>
 </form>
