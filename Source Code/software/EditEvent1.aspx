<%@ Page Language="C#" MasterPageFile="~/Site6.Master" AutoEventWireup="true" CodeBehind="EditEvent1.aspx.cs" Inherits="software.EditEvent1" Title="Untitled Page" %>
...
<asp:GridView ID="GridView1" runat="server" Width="750px" 
        ...
        AllowSorting="True" AutoGenerateColumns="False" >
         <Columns>
                        ...
                        <asp:BoundField DataField="CurrentDate" HeaderText="Date Of Post" ItemStyle-HorizontalAlign="Center" />  
...
<h3>Subject:</h3>
    ...
    <h3>Description:</h3>
    <asp:TextBox ID="TxtEditEvent" runat="server" style ="height:200px;"  Columns="40" TextMode = "MultiLine"></asp:TextBox><br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ErrorMessage="Please enter Description" 
    ControlToValidate="TxtEditEvent" runat="server" /><br />
    
    <asp:Button ID="BtnEditEvent" runat="server"
        Text="EDIT"  onclick="BtnEditEvent_Click"/><br/>
    </div>
    </center>
</asp:Panel>
 </form>
