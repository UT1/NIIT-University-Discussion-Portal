...
namespace software
{
    public partial class ApprovePost1 : System.Web.UI.Page
    {
        ...
        public void Fill_Grid()
        {
            ...
            Csql.Open();
            SqlCommand Cmmd = new SqlCommand("Select * from Create_Loss ", Csql);
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            SqlConnection Csql = new SqlConnection("Data source=SHRONITBHARGAVA\\SQLEXPRESS; initial catalog=Project; integrated security=SSPI;persist security info=False; Trusted_Connection=Yes");
            Csql.Open();
            SqlCommand Cmmd = new SqlCommand("update Create_Loss set status = 'Approved',comments ='" + TxtComment.Text + "',DoneBy = '" + Label1.Text + "' where PostId='" + Session["id"] + "'", Csql);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            SqlConnection Csql = new SqlConnection("Data source=SHRONITBHARGAVA\\SQLEXPRESS; initial catalog=Project; integrated security=SSPI;persist security info=False; Trusted_Connection=Yes");
            Csql.Open();
            SqlCommand Cmmd = new SqlCommand("update Create_Loss set status = 'Rejected',comments ='" + TxtComment.Text + "',DoneBy = '" + Label1.Text + "' where PostId='" + Session["id"] + "'", Csql);
            Cmmd.ExecuteNonQuery();
            Csql.Close();
            Page_Load(null, EventArgs.Empty);
        }
