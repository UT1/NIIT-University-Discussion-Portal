...
namespace software
{
    public partial class Editfoundpost : System.Web.UI.Page
    {
        ...
        public void Fill_Grid()
        {
            ...
            Csql.Open();
            SqlCommand Cmmd = new SqlCommand("Select * from Create_Foun where username = '" + Label1.Text + "'", Csql);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    LinkButton SelectButton = (LinkButton)e.Row.Cells[6].Controls[0];
